...
## OUTPUT:
<img width="1065" height="238" alt="image" src="https://github.com/user-attachments/assets/7a45e651-2731-4c79-8d6d-637e36116cd0" />

## RESULT:
The host took "1.116914" seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in "0.138656" seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
